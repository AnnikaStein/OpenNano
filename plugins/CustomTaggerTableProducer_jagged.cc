...
template<typename T>
class JetConstituentTableProducerCustomTaggerJagged : public edm::stream::EDProducer<> {
public:
  explicit JetConstituentTableProducerCustomTaggerJagged(const edm::ParameterSet &);
  ~JetConstituentTableProducerCustomTaggerJagged() override;
...
private:
  ...
  const std::string nameCustomTaggerJagged_;
  //const std::string idx_name_;
  //const std::string idx_nameSV_;
  const std::string idx_nameCustomTaggerJagged_;
  const std::string storeAK4Truth_;    
  const bool readBtag_;
  const double jet_radius_;
  const bool add_CustomTaggerJagged_noclip_;
...
//
template< typename T>
JetConstituentTableProducerCustomTaggerJagged<T>::JetConstituentTableProducerCustomTaggerJagged(const edm::ParameterSet &iConfig)
    : //name_(iConfig.getParameter<std::string>("name")),
      //nameSV_(iConfig.getParameter<std::string>("nameSV")),
      nameCustomTaggerJagged_(iConfig.getParameter<std::string>("nameCustomTaggerJagged")),
      //idx_name_(iConfig.getParameter<std::string>("idx_name")),
      //idx_nameSV_(iConfig.getParameter<std::string>("idx_nameSV")),
      idx_nameCustomTaggerJagged_(iConfig.getParameter<std::string>("idx_nameCustomTaggerJagged")),
      storeAK4Truth_(iConfig.getParameter<std::string>("storeAK4Truth")),
      readBtag_(iConfig.getParameter<bool>("readBtag")),
      jet_radius_(iConfig.getParameter<double>("jet_radius")),
      add_CustomTaggerJagged_noclip_(iConfig.getParameter<bool>("add_CustomTaggerJagged_noclip")),
  ...
  produces<nanoaod::FlatTable>(nameCustomTaggerJagged_);
  //produces<std::vector<reco::CandidatePtr>>();
}

template< typename T>
JetConstituentTableProducerCustomTaggerJagged<T>::~JetConstituentTableProducerCustomTaggerJagged() {}

template< typename T>
void JetConstituentTableProducerCustomTaggerJagged<T>::produce(edm::Event &iEvent, const edm::EventSetup &iSetup) {
  ...
  //std::cout << "In producer: add_CustomTaggerJagged_noclip_ ? " << add_CustomTaggerJagged_noclip_ << std::endl;  
    ...
    for (const auto &sv : jetSVs) {
      ...
      if (readBtag_ && !vtxs_->empty()) {
        ...
        if (i_sv_in_jet < n_sv_) {   
          ...
          // no clip
          if (add_CustomTaggerJagged_noclip_) {
...
*/
      if (readBtag_ && !vtxs_->empty()) {
        ...
        if ( packedCand->charge() != 0 ) {
            ...
            // need only the first 25 cpfs for CustomTaggerJagged
            ...
            if ( packedCand && packedCand->hasTrackDetails()){
              ...
              // no clip was default inside JetConstituentTableProducer, but CustomTaggerJagged seems to use the clipped versions
              if (add_CustomTaggerJagged_noclip_) {
  ...
  // CustomTaggerJaggedInputs table
  auto customTable = std::make_unique<nanoaod::FlatTable>(jetIdx_dj.size(), nameCustomTaggerJagged_, false, true);
  customTable->addColumn<int>("CustomTaggerJagged_jetIdx", jetIdx_dj, "Index of the parent jet", nanoaod::FlatTable::IntColumn);
    
    
  // customTable->addColumn<int>("CustomTaggerJagged_nCpfcand", jet_N_CPFCands, "Number of charged PF candidates in the jet", nanoaod::FlatTable::IntColumn);
  // customTable->addColumn<int>("CustomTaggerJagged_nNpfcand", jet_N_NPFCands, "Number of neutral PF candidates in the jet", nanoaod::FlatTable::IntColumn);
  // customTable->addColumn<int>("CustomTaggerJagged_nsv", jet_N_SVs, "Number of secondary vertices in the jet", nanoaod::FlatTable::IntColumn);
    
  customTable->addColumn<int>("CustomTaggerJagged_nCpfcand",
                          jet_N_CPFCands,
                          "Number of charged PF candidates in the jet",
                          nanoaod::FlatTable::IntColumn);
  customTable->addColumn<int>("CustomTaggerJagged_nNpfcand",
                          jet_N_NPFCands,
                          "Number of neutral PF candidates in the jet",
                          nanoaod::FlatTable::IntColumn);
  customTable->addColumn<int>("CustomTaggerJagged_nsv",
                          jet_N_SVs,
                          "Number of secondary vertices in the jet",
                          nanoaod::FlatTable::IntColumn);
  customTable->addColumn<int>("CustomTaggerJagged_npv",
                          jet_N_PVs,
  ...
  for (unsigned int p = 0; p < n_cpf_; p++) {
      ...
      // ============================================================== Cpfs ===================================================================
      input_name = "CustomTaggerJagged_Cpfcan_puppiw_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_VTX_ass_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_drminsv_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_ptrel_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_quality_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_chi2_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackDeltaR_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackEtaRel_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackJetDistVal_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackPPar_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackPParRatio_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackPtRel_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip2dSig_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip3dSig_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip2dVal_" + s;
      ...
      input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip3dVal_" + s;
  ...
  for (unsigned int p = 0; p < n_npf_; p++) {
      auto s = std::to_string(p);
      input_name = "CustomTaggerJagged_Npfcan_puppiw_" + s;
      ...
      input_name = "CustomTaggerJagged_Npfcan_deltaR_" + s;
      ...
      input_name = "CustomTaggerJagged_Npfcan_drminsv_" + s;
      ...
      input_name = "CustomTaggerJagged_Npfcan_HadFrac_" + s;
      ...
      input_name = "CustomTaggerJagged_Npfcan_ptrel_" + s;
      ...
      input_name = "CustomTaggerJagged_Npfcan_isGamma_" + s;
      ...
      if (add_CustomTaggerJagged_noclip_) {
          // cpf
          input_name = "CustomTaggerJagged_Cpfcan_drminsv_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_ptrel_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_chi2_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackDeltaR_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackEtaRel_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackJetDistVal_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackPPar_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackPParRatio_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackPtRel_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip2dSig_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip3dSig_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip2dVal_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Cpfcan_BtagPf_trackSip3dVal_noclip_" + s;
          ...
          // npf
          input_name = "CustomTaggerJagged_Npfcan_deltaR_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Npfcan_drminsv_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_Npfcan_ptrel_noclip_" + s;
  ...
  for (unsigned int p = 0; p < n_sv_; p++) {
      ...
      input_name = "CustomTaggerJagged_sv_mass_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_pt_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_ntracks_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_chi2_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_normchi2_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_dxy_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_dxysig_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_d3d_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_d3dsig_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_costhetasvpv_" + s;
      ...
      input_name = "CustomTaggerJaggedExtra_sv_phirel_" + s;
      ...
      input_name = "CustomTaggerJaggedExtra_sv_ptrel_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_deltaR_" + s;
      ...
      input_name = "CustomTaggerJagged_sv_enratio_" + s;
      ...
      if (add_CustomTaggerJagged_noclip_) {
          input_name = "CustomTaggerJagged_sv_normchi2_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_sv_dxysig_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_sv_d3dsig_noclip_" + s;
          ...
          input_name = "CustomTaggerJagged_sv_deltaR_noclip_" + s;
  ...
  iEvent.put(std::move(customTable), nameCustomTaggerJagged_);  
  
}

template< typename T>
void JetConstituentTableProducerCustomTaggerJagged<T>::fillDescriptions(edm::ConfigurationDescriptions &descriptions) {
  edm::ParameterSetDescription desc;
  desc.add<std::string>("nameCustomTaggerJagged", "Jet");
  desc.add<std::string>("idx_nameCustomTaggerJagged", "customIdx");
  ...
  desc.add<bool>("add_CustomTaggerJagged_noclip", false);
  descriptions.addWithDefaultLabel(desc);
}

typedef JetConstituentTableProducerCustomTaggerJagged<pat::Jet> PatJetConstituentTableProducerCustomTaggerJagged;
//typedef JetConstituentTableProducerCustomTaggerJagged<reco::GenJet> GenJetConstituentTableProducerCustomTaggerJagged;

DEFINE_FWK_MODULE(PatJetConstituentTableProducerCustomTaggerJagged);
//DEFINE_FWK_MODULE(GenJetConstituentTableProducerCustomTaggerJagged);