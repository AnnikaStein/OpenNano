...
# with command line options: --python_filename custom_tt_cfg.py --eventcontent NANOAODSIM --datatier NANOAODSIM --fileout file:/tmp/custom_nanoaod.root --conditions 102X_mcRun2_asymptotic_v8 --step NANO --filein file:/tmp/miniaod.root --era Run2_25ns,run2_nanoAOD_106X2015 --no_exec --mc -n 100 --customise PhysicsTools/OpenNano/opennano_cff.Opennano_customizeMC_allPF_add_CustomTagger_and_Truth
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/tmp/miniaod.root'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:/tmp/custom_nanoaod.root'),
