...
# with command line options: --python_filename custom_dy_cfg.py --eventcontent NANOAODSIM --datatier NANOAODSIM --fileout file:custom_dy_nanoaod.root --conditions 102X_mcRun2_asymptotic_v8 --step NANO --filein file:dy_miniaod.root --era Run2_25ns,run2_nanoAOD_106X2015 --no_exec --mc -n -1 --customise PhysicsTools/PFNano/pfnano_cff.PFnano_customizeMC_allPF_add_CustomTagger_and_Truth
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:custom_dy_nanoaod.root'),
